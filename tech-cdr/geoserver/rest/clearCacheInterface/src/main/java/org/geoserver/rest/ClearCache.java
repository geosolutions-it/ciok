...
public interface ClearCache {
    ...
    public void deleteCube(String workspace, String layer, String catalog, String schema, String cube);
    ...
    public void deleteConnection(String workspace, String layer, String catalog, String schema, String cube, String connection);
